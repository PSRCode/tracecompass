...
public class TimeGraphControl extends TimeGraphBaseControl
    ...
    public void setPinState(boolean state) {
        ...
        fPrevEventEnabled = !state;
        fNextEventEnabled = !state;
        fGrabAndPanEnabled = !state;
        fSelectionZoomEnabled = !state;
        fHorizontalZoomEnabled = !state;
        fHorizontalScrollEnabled = !state;
        fTimeRangeSelectionEnabled = !state;
    }
}
