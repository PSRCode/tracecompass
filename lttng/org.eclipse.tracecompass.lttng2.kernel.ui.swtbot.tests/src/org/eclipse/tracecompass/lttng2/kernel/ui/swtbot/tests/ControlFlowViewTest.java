...
public class ControlFlowViewTest extends KernelTimeGraphViewTestBase {
    ...
    public void testDynamicFiltersDialog() {
        ...
        fViewBot.viewMenu(DYNAMIC_FILTER_CONFIGURE_LABEL).click();
        ...
        assertTrue(fViewBot.viewMenu(DYNAMIC_FILTER_ACTIVE_THREADS_ONLY_TOGGLE).isChecked());

        /* Make sure that the Flat presentation is checked */
        assertTrue(fViewBot.viewMenu(THREAD_PRESENTATION_FLAT).isChecked());
        assertFalse(fViewBot.viewMenu(THREAD_PRESENTATION_HIERARCHICAL).isChecked());
